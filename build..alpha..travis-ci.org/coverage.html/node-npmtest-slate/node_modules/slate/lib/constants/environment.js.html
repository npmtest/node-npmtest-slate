...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-slate/node_modules/slate/lib/constants/environment.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-slate/node_modules/slate/lib/constants/environment.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-slate/node_modules/slate/lib/constants/</a> &#187; environment.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (_isInBrowser2.default) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var _iterator = BROWSER_RULES[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >      var rule = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _rule = _slicedToArray(rule, 2),</span>
          name = _rule[0],
          regexp = _rule[1];
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (regexp.test(userAgent)) {</span>
<span class="cstat-no" title="statement not covered" >        BROWSER = name;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    for (var _iterator2 = OS_RULES[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
<span class="cstat-no" title="statement not covered" >      var _rule2 = _step2.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _rule3 = _slicedToArray(_rule2, 2),</span>
          name = _rule3[0],
          regexp = _rule3[1];
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (regexp.test(userAgent)) {</span>
<span class="cstat-no" title="statement not covered" >        OS = name;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
      }
    }
  } catch (err) {
